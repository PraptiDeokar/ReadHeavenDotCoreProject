...
namespace Project.DataAccess.Migrations
{
    ...
    [Migration("20231217071819_AddOrderHeaderAndOrderDetailToDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Project.Models.Models.Company", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PostalCode = "412212",
                            State = "MH",
                            StreetAddress = "21 sector"
                        });
                });

            modelBuilder.Entity("Project.Models.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Project.Models.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Project.Models.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Project.Models.Models.OrderDetail", b =>
                {
                    b.HasOne("Project.Models.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Project.Models.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Project.Models.ApplicationUser", b =>
                {
                    b.HasOne("Project.Models.Models.Company", "Company")
                        .WithMany()
